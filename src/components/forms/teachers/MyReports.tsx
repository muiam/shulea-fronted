...
function MyReports() {
  ...
  const getReport = async () => {
    if (selectedGrade && selectedWeek) {
      let response = await fetch(
        getPrivateUrl(
          `app/student/my/progress/weekly/reports/${selectedGrade}/${selectedWeek}`
        ),
        {
          method: "GET",
          headers: getHeadersWithAuth(),
      ...
      let response = await fetch(
        getPrivateUrl(
          `app/student/my/progress/weekly/reports/level/${selectedGrade}/`
        ),
        {
          method: "GET",
          headers: getHeadersWithAuth(),
      ...
      let response = await fetch(
        getPrivateUrl(
          `app/student/my/progress/weekly/reports/week/${selectedWeek}/`
        ),
        {
          method: "GET",
          headers: getHeadersWithAuth(),
  ...
  const handleReportData = (id: number) => {
    navigate(`/report/my/kid/progress/${id}/`);
  };

  const compose = () => {
    navigate(`/report/compose/`);
  };
  return (
    <>
      <ToastContainer />
